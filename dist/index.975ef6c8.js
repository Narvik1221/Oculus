...
button.forEach((button)=>{
    button.addEventListener("click", function(event) {
        ...
        if (currentlySelectedElem) currentlySelectedElem.classList.remove("_active");
...
(0, _carList.carsList).forEach((el)=>{
    content.insertAdjacentHTML("afterbegin", el.toHtml());
});
new (0, _sidebar.Sidebar)(".list", (newBlock)=>{}); // const carsHTML=carsList.map(car=>{
...
},{"./carList":"guPbD","./utils":"en4he","./Sidebar":"l3iw5"}],"guPbD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "carsList", ()=>carsList);
...
const cssStyle = (0, _utils.css)(style);
const carsList = [
    new (0, _classes.Block)("Tesla", "h5", {
        tag: "h6",
        styles: {
            cssStyle
        }
    }),
    new (0, _classes.Block)("Ssmesla", "h6", {
        tag: "h6",
        styles: {
            cssStyle
        }
    }),
    new (0, _classes.Block)("BMW", "h1", {
        tag: "h6",
        styles: {
            cssStyle
        }
...
},{"./classes":"34PXX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./utils":"en4he"}],"34PXX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Block {
    ...
    toHtml() {
        return (0, _utils.wrapper)(this.content, this.tag, (0, _utils.css)(this.style.styles));
    }
}
...
function wrapper(content = "", tag = "div", style = "") {
    return ` <${tag} class="" style="${css(style)}">${content} </${tag}>`;
}
function css(styles = {}) {
    if (typeof styles === "string") return styles;
    return Object.keys(styles).map((keys)=>`${keys}: ${styles[keys]}`).join(";");
}
...
},{}],"l3iw5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Sidebar {
    ...
    add(event) {
        ...
        let newBlock;
        newBlock = new (0, _classes.Block)(name, "div", {
            styles: styles
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./classes":"34PXX"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire7f04")
